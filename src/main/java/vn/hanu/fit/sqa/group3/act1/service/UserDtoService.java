...
public class UserDtoService {
    public UserDtoService(UserService userService, TokenService tokenService, EmailService emailSender ) {
        ...
        @Transactional
        public String confirmToken(String str) {
    ...
    @Autowired private final EmailService emailSender;
